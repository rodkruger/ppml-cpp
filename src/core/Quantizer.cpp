...
namespace hermesml {
    std::vector<std::vector<int64_t> > Quantizer::Quantize(const std::vector<std::vector<double> > &data) {
    ...
    std::vector<int64_t> Quantizer::Quantize(const std::vector<double> &data) {
