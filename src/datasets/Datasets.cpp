...
namespace hermesml {
    ...
    std::vector<std::vector<double> > Dataset::GetTrainingFeatures() {
        switch (this->range) {
            case FM88: return this->ReadFeatures("training_features_range88.csv");
            ...
            case FM11: return this->ReadFeatures("training_features_range11.csv");
            default: return {};
        }
    }
    ...
    std::vector<double> Dataset::GetTrainingLabels() {
        switch (this->range) {
            case FM88: return this->ReadLabels("training_labels_range88.csv");
            case FM22: return this->ReadLabels("training_labels_range22.csv");
            case F01: return this->ReadLabels("training_labels_range01.csv");
            case FM11: return this->ReadLabels("training_labels_range11.csv");
            default: return {};
        }
    }
    ...
    std::vector<std::vector<double> > Dataset::GetTestingFeatures() {
        switch (this->range) {
            case FM88: return this->ReadFeatures("testing_features_range88.csv");
            ...
            case FM11: return this->ReadFeatures("testing_features_range11.csv");
            default: return {};
        }
    }
    ...
    std::vector<double> Dataset::GetTestingLabels() {
        switch (this->range) {
            case FM88: return this->ReadLabels("testing_labels_range88.csv");
            case FM22: return this->ReadLabels("testing_labels_range22.csv");
            case F01: return this->ReadLabels("testing_labels_range01.csv");
            case FM11: return this->ReadLabels("testing_labels_range11.csv");
            default: return {};
        }
    }
}
