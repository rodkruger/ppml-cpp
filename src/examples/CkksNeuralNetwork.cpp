...
int main() {
    ...
    for (auto i = 1; i <= epochs; i++) {
        for (auto j = 0; j < datasets11.size(); j++) {
            ...
            params.epochs = i;
            params.earlyBootstrapping = 0;
            CkksNeuralNetworkExperiment("ckks_tanh_taylor_" + std::to_string(params.epochs), *datasets11[j],
                                        params).Run();
            ...
            params.epochs = i;
            params.earlyBootstrapping = 0;
            CkksNeuralNetworkExperiment("ckks_tanh_least_squares_" + std::to_string(params.epochs), *datasets11[j],
                                        params).Run();
            ...
            params.epochs = i;
            params.earlyBootstrapping = 0;
            CkksNeuralNetworkExperiment("ckks_sigmoid_chebyshev_" + std::to_string(params.epochs), *datasets11[j],
                                        params).Run();
            ...
            params.epochs = i;
            params.earlyBootstrapping = 0;
            CkksNeuralNetworkExperiment("ckks_sigmoid_taylor_" + std::to_string(params.epochs), *datasets11[j],
                                        params).Run();
            ...
            params.epochs = i;
            params.earlyBootstrapping = 0;
            CkksNeuralNetworkExperiment("ckks_sigmoid_least_squares_" + std::to_string(params.epochs),
                                        *datasets11[j],
                                        params).Run();
            */
        }
